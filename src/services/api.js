...
export const submitQuizAnswers = (id, answers) => backendAPI.post(`/quizzes/${id}/submit`, { answers })

export const fetchUserProgress = (userId) => backendAPI.get(`/auth/users/progress/${userId}`)

export const loginUser = (credentials) => backendAPI.post("/auth/login", credentials)

export const registerUser = (userDetails) => backendAPI.post("/auth/register", userDetails)
...
export const fetchGrandmasterGames = (username, year, month) => chessAPI.get(`/${username}/games/${year}/${month}`)
